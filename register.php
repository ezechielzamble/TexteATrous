...
$bdd = new PDO('mysql:host=localhost;dbname=gtt','root','',array(PDO::MYSQL_ATTR_INIT_COMMAND=>"SET NAMES'utf8'"));
...
{
		$pdoStat = $bdd->prepare('INSERT INTO `users` VALUES (NULL, :email, :nom, :motdepasse)');
		$mail = $pdoStat->bindValue(':email', htmlspecialchars(trim($_POST['email'])), PDO::PARAM_STR);
        $nm = $pdoStat->bindValue(':nom', htmlspecialchars(trim($_POST['nom'])), PDO::PARAM_STR);
        $mdp = $pdoStat->bindValue(':motdepasse', sha1(htmlspecialchars(trim($_POST['motdepasse']))), PDO::PARAM_STR);
		...
		<div class="header_content d-flex flex-row align-items-center justify-content-start trans_400">
			...
			<div class="header_right d-flex flex-row align-items-center justify-content-start">
				...
				<div class="header_links">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						<li><a href="bim.php?page=home">Accueil</a></li>
						<!-- <li><a href="#">Chat</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-8 offset-lg-2 contact_form_col">
					...
					<div class="contact_form_container"><br/>
						<form action="" class="contact_form" id="regform" method="POST">
							<div class="row contact_row">

								<div class="col-lg-6"><input type="email" id="email" class="contact_input" name="email" placeholder="E-mail" ></div><br>
								<div class="col-lg-6"><input type="text" id="nom" class="contact_input" name="nom"  placeholder="Votre nom" ></div><br>
								
								<div class="col-lg-6"><input type="password" id="motdepasse" class="contact_input" required="required" name="motdepasse" placeholder="mot de passe" ></div><br>
								<div class="col-lg-6"><input type="password" id="motdepasse2" class="contact_input" required="required" name="motdepasse2" placeholder="confirmer mot de passe" ></div><br>
